#ifndef OPENCHECKERS_PLAT_IOS_H
#define OPENCHECKERS_PLAT_IOS_H

#include "oc_types.h" // Vector2, bool

// State pushed from the UIKit view (ios_main.mm) into the C-facing queries the
// game reads through oc_types.h (GetScreenWidth / GetTouchPosition / …). All
