# Getting opencheckers into TestFlight
...
Throughout: bundle ID is `com.danheskett.opencheckers`, and it must match
...
- Type: **App IDs** → **App**
- Description: `opencheckers`
- Bundle ID: **Explicit** → `com.danheskett.opencheckers`
...
- App ID: `com.danheskett.opencheckers`
...
| --- | --- |
| Platform | iOS |
| Name | `opencheckers` (see [LISTING.md](LISTING.md) for fallbacks if taken) |
