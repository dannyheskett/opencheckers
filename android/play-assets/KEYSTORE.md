...
keytool -genkeypair -v \
  -keystore opencheckers-upload.jks \
  -alias opencheckers-upload \
  -keyalg RSA -keysize 2048 -validity 10000 \
  -dname "CN=Danny Heskett, O=opencheckers, C=US"
```

It prompts for a **keystore password** and a **key password** — pick strong
ones and save them in your password manager. Keep `opencheckers-upload.jks`
...
```sh
base64 -w0 opencheckers-upload.jks > upload.jks.b64
gh secret set PLAY_UPLOAD_KEYSTORE   < upload.jks.b64
gh secret set PLAY_KEY_ALIAS         -b "opencheckers-upload"
...
secret and produce `opencheckers-<version>-android.aab` alongside the sideload
