package com.danheskett.opencheckers;
 ...
 */
public class OpencheckersActivity extends NativeActivity {

    // NativeActivity loads libopencheckers.so by dlopen()ing it in framework
    ...
    static {
        System.loadLibrary("opencheckers");
    }
